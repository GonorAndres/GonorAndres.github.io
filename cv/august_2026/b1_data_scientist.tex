...
%
% August 2026 CV — Andrés González Ortega (ES — B1 Data Scientist)
...
% PDF metadata
\hypersetup{
  pdftitle={Andrés González Ortega — CV Agosto 2026 (B1 Data Scientist)},
...
\position{Ciencia de Datos{\enskip\cdotp\enskip}Machine Learning{\enskip\cdotp\enskip}GCP}
...
\begin{cvparagraph}
Soy actuario de la UNAM con \textbf{SOA Exam Probability aprobado}, becario de ciencia de datos en \textbf{Grupo Gigante} y co-autor de artículo científico en el \textbf{IGF-UNAM}. Modelo problemas diversos donde los datos revelan riesgo y oportunidad: desde anticipar abandono de clientes hasta detectar exposición crediticia invisible en grafos, con soluciones explicables y listas para producción. Practico la formación continua y disfruto el trabajo colaborativo con equipos multidisciplinarios. En mi \hrefIcon{https://gonor.me/}{página web} publico 25+ proyectos en producción, notas técnicas bilingües y aprendizajes abiertos a cualquier disciplina.
\end{cvparagraph}
