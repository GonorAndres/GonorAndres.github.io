...
%
% August 2026 CV — Andrés González Ortega (C1 — Risk Management ES)
...
% PDF metadata
\hypersetup{
  pdftitle={Andrés González Ortega — CV Agosto 2026 C1 Risk Management},
...
\position{Riesgo Cuantitativo{\enskip\cdotp\enskip}Ciencia Actuarial{\enskip\cdotp\enskip}GCP}
...
\begin{cvparagraph}
Soy actuario de la UNAM con \textbf{SOA Exam Probability aprobado}, becario de ciencia de datos en \textbf{Grupo Gigante} y co-autor de artículo científico en el \textbf{IGF-UNAM}. Me interesa lo que es difícil de medir: la exposición que el SQL no ve en una cartera, el evento raro que los promedios ignoran, el capital que un regulador exige bajo estrés. Construyo herramientas que conectan datos, finanzas y gestión de riesgo para cuantificarlo. Practico la formación continua y disfruto el trabajo colaborativo con equipos multidisciplinarios. En mi \hrefIcon{https://gonor.me/}{página web} publico 25+ proyectos en producción, notas técnicas bilingües y aprendizajes abiertos a cualquier disciplina.
\end{cvparagraph}
