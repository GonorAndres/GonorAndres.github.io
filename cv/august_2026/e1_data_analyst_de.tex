...
%
% August 2026 CV — Andrés González Ortega (ES — E1 Data Analyst / Data Engineer)
...
% Override placetopright date size to fit "Agosto 2026" in 1.3cm box
...
% PDF metadata
\hypersetup{
  pdftitle={Andrés González Ortega — CV Agosto 2026 — E1 Data Analyst/DE},
...
\position{Actuario{\enskip\cdotp\enskip}Ingeniería de Datos}
...
\placetopright{Agosto 2026}{../qr_portfolio.png}
...
\begin{cvparagraph}
Soy actuario de la UNAM con \textbf{SOA Exam Probability aprobado}, becario de ciencia de datos en \textbf{Grupo Gigante} y co-autor de artículo científico en el \textbf{IGF-UNAM}. Diseño la infraestructura que convierte datos dispersos en decisiones: pipelines, warehouses, orquestación y dashboards que conectan el dato crudo con el modelo y el usuario final. Practico la formación continua y disfruto el trabajo colaborativo con equipos multidisciplinarios. En mi \hrefIcon{https://gonor.me/}{página web} publico 25+ proyectos en producción, notas técnicas bilingües y aprendizajes abiertos a cualquier disciplina.
\end{cvparagraph}
...
\begin{cvskills}
  ...
  \cvskill
    {Ciencia Actuarial}
    {Tarificación (GLM, frecuencia-severidad, credibilidad), Reservas (BEL, IBNR, Chain Ladder, BF), Lee-Carter, RCS/SCR bajo LISF/CUSF (análogo a Solvency II), Reaseguro, Pensiones IMSS}
...
\begin{cventries}
  ...
  \cventry
    ...
    {}
    {}
    {\hrefIcon{https://gonor.me/blog/data-engineering-platform/}{blog}}
    {
      \begin{cvitems}
  ...
  \cventry
    ...
    {}
    {}
    {\hrefIcon{https://gonor.me/blog/credit-graph-topological-risk/}{blog}}
    {
      \begin{cvitems}
  ...
  \cventry
    {Flight Analytics — PostgreSQL a BigQuery}
    {}
    {}
    {\hrefIcon{https://gonor.me/blog/flight-analytics-pg-bq/}{blog}}
    {
      \begin{cvitems}
        \item {Tres aerolíneas, 5.74M vuelos, datos dispersos en CSVs sin esquema común. ETL PostgreSQL a \hl{BigQuery}, optimización de queries (\hl{44x-3,024x} speedup), mapa WebGL de rutas y análisis Pareto: 128 rutas concentran 80\% del ingreso. \textit{Python, PostgreSQL, Next.js, deck.gl.}}
      \end{cvitems}
    }
