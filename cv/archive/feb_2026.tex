...
\begin{document}
    ...
    \section{Sobre mí}
        ...
        \begin{onecolentry}
Pasante de la \textbf{Licenciatura en Actuaría} (UNAM, Facultad de Ciencias) y \textbf{Becario de Ciencia de Datos} en Grupo Gigante. Actualmente en servicio social como asistente de investigación científica en el Instituto de Geofísica (UNAM) y en proceso de titulación mediante los exámenes SOA. Experiencia en ingeniería de datos en GCP (BigQuery, Cloud SQL, FastAPI), modelación actuarial (Lee-Carter, reservas, RCS) y machine learning (scikit-learn, PyTorch). Integro herramientas de IA -- incluyendo agentes y LLMs -- en el flujo de trabajo técnico para hacer más con mayor precisión. Domino Python, R y SQL.
        \end{onecolentry}
    ...
    \section{Experiencia}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                \item Trabajo en el CDP del grupo: una plataforma de \textbf{gestión de grandes volúmenes de datos} adaptada a la lógica de cada marca (Office Depot, Casa Ideas y otras), con \textbf{resolución de identidad} para consolidar un perfil único por cliente. Sobre esa base construí un modelo de \textbf{churn} para estimar probabilidad de abandono y orientar campañas de retención segmentadas. \textit{Python, scikit-learn, BigQuery, Cloud~SQL, Docker.}
                \item Implementé el sistema de \textbf{seguimiento comportamental} web del grupo con un enfoque \textbf{híbrido}: cada unidad de negocio tiene su propia lógica de audiencias, \textbf{feature flags} y personalización de experiencia. \textit{PostHog, TypeScript.}
            \end{highlights}
        \end{twocolentry}
        ...
        \begin{twocolentry}{
            ...
            \begin{highlights}
                \item Participé como co-autor en un artículo (pendiente de publicación) sobre pronóstico de erupciones del Popocatépetl. Modelé los tiempos de reposo mediante \textbf{procesos de renovación} (\textbf{Weibull}, mezcla de exponenciales, Browniano inverso gaussiano) para construir \textbf{intervalos de confianza} sobre el inicio y término de actividad eruptiva. Continúo apoyando al Dr. Delgado-Granados en enfoques estadísticos para datos geofísicos. \textit{R, inferencia estadística, análisis de supervivencia.}
...
\end{onecolentry}
    ...
    \begin{onecolentry}
        \begin{highlightsforbulletentries}
            ...
            \item \textbf{Exámenes SOA:} P (Mar 2026), FM (Abr 2026), SRM (May 2026) -- programados
        \end{highlightsforbulletentries}
    \end{onecolentry}
...
\begin{twocolentry}{
    ...
    \begin{highlights}
        \item Entrené un \textbf{transformer decoder-only} desde cero -- sin \textbf{transfer learning} -- sobre el corpus en español de \textit{En busca del tiempo perdido}. El modelo aprende la sintaxis y el ritmo literario de Proust para generar texto; entrenado en Google Colab como solución al costo computacional. \textit{PyTorch, Tokenizers.}
    \end{highlights}
\end{twocolentry}
...
\begin{twocolentry}{
    \href{https://drive.google.com/file/d/1yi3ml6M0AqRijSQ4R36KaId4pP3GhpME/view?usp=sharing}{PDF}
}
    \textbf{Optimización de Portafolio -- Markowitz}
    \begin{highlights}
        \item Optimicé un portafolio de 10 activos del mercado mexicano bajo restricciones de diversificación: \textbf{frontera eficiente}, \textbf{VaR paramétrico} (95\%), backtesting y pruebas de estrés en períodos de alta volatilidad. \textit{Excel.}
    \end{highlights}
\end{twocolentry}
