...
\usepackage{amsmath}
\usepackage[pdftitle={Andrés Ortega CV -- C1 Risk Management},pdfauthor={Andrés González Ortega},pdfcreator={LaTeX with RenderCV},colorlinks=true,urlcolor=primaryColor]{hyperref}
...
\begin{document}
    ...
    \section{Sobre mí}
        \begin{onecolentry}
Soy actuario de la UNAM con \textbf{SOA Exam Probability aprobado}, becario de ciencia de datos en \textbf{Grupo Gigante} y co-autor de artículo en el IGF-UNAM sobre eventos raros (Popocatépetl). Cuantifico \textbf{riesgo} donde los modelos estándar se quedan cortos: capital bajo \textbf{LISF}, scoring crediticio en \textbf{Neo4j}, \textbf{VaR/CVaR} con cópulas. Practico la formación continua y disfruto el trabajo colaborativo con equipos multidisciplinarios. En \href{https://gonorandres.github.io/blog/}{mi página web} comparto lo que aprendo y construyo.
        \end{onecolentry}
...
\begin{onecolentry}
    \begin{highlightsforbulletentries}
        ...
        \item \textit{Riesgo Cuantitativo:} VaR, CVaR, EVT, Cópulas, Monte Carlo, Black-Scholes, Derivados, Backtesting, Stress Testing, Scoring topológico
        \item \textit{Ciencia Actuarial:} Lee-Carter, Reservas (BEL, IBNR), RCS/SCR, LISF/CUSF, Tablas de Mortalidad, Procesos renovación Weibull
        \item \textit{ML \& Datos:} scikit-learn, XGBoost, LightGBM, GLM, Neo4j, PySpark, Databricks, Pandas, BigQuery
        \item \textit{IA \& Agentes:} LLMs, Claude API, RAG, FTS5/BM25
...
\begin{twocolentrynarrow}{\href{https://gonorandres.github.io/blog/risk-analyst/}{blog}}
    ...
    \begin{highlights}
        \item El riesgo cuantitativo no se domina con un modelo único. Serie de 13 proyectos: desde \hl{VaR/CVaR} diario de portafolio hasta contagio sistémico entre instituciones, con acciones, bonos y opciones sobre datos reales. \textit{Python, Monte Carlo, cópulas, deep learning.}
    \end{highlights}
