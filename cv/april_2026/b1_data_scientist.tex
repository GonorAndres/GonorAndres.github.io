...
\usepackage{amsmath}
\usepackage[pdftitle={Andrés Ortega CV -- B1 Data Scientist},pdfauthor={Andrés González Ortega},pdfcreator={LaTeX with RenderCV},colorlinks=true,urlcolor=primaryColor]{hyperref}
...
\begin{document}
    ...
    \section{Sobre mí}
        \begin{onecolentry}
Soy actuario de la UNAM con \textbf{SOA Exam Probability aprobado}, becario de ciencia de datos en \textbf{Grupo Gigante} y co-autor de artículo científico en el IGF-UNAM. Llevo modelos de \textbf{machine learning} a producción y los mantengo explicables: clasificación para churn, pricing \textbf{GLM}+\textbf{XGBoost} con \textbf{SHAP}, un transformer entrenado desde cero sobre \textbf{Databricks} y \textbf{GCP}. Practico la formación continua y disfruto el trabajo colaborativo con equipos multidisciplinarios. En \href{https://gonorandres.github.io/blog/}{mi página web} comparto lo que aprendo y construyo.
        \end{onecolentry}
...
\begin{onecolentry}
    \begin{highlightsforbulletentries}
        \item \textit{Lenguajes:} Python, R, SQL, TypeScript, Bash, Git, \LaTeX
        ...
        \item \textit{IA \& Estadística:} Transformers desde cero, LLMs, Claude API, RAG, Inferencia Bayesiana, Series de Tiempo (ARIMA)
        \item \textit{Dominio Actuarial/Riesgo:} Seguros Vida y Daños, Lee-Carter, BEL, LISF/CUSF, Scoring crediticio topológico
...
\begin{twocolentrynarrow}{\href{https://huggingface.co/spaces/GonorAndres/proust-attention}{app live}}
    \textbf{La Máquina de Atención de Proust}
    \begin{highlights}
        \item Los LLM se usan a diario pero pocos saben qué pasa dentro. \hl{Transformer} character-level entrenado con Proust, construido desde cero: embeddings, atención multi-cabeza y Feed-Forward como multiplicaciones de matrices. \textit{PyTorch, NumPy.}
    \end{highlights}
\end{twocolentrynarrow}
...
\begin{twocolentrynarrow}{\href{https://gonorandres.github.io/blog/actuarial-ml-pricing/}{blog}}
    \textbf{Tarificación de Seguros con ML}
    \begin{highlights}
        \item El modelo actuarial interpreta; ML predice. Pipeline que corre ambos y evalúa equidad entre género y edad: \hl{GLM} base vs \hl{XGBoost} con explicabilidad \hl{SHAP}. \textit{Python, FastAPI, scikit-learn.}
    \end{highlights}
\end{twocolentrynarrow}
