...
\usepackage{amsmath}
\usepackage[pdftitle={Andrés Ortega CV -- F1 Financial},pdfauthor={Andrés González Ortega},pdfcreator={LaTeX with RenderCV},colorlinks=true,urlcolor=primaryColor]{hyperref}
...
\newenvironment{highlights}{
    \begin{itemize}[topsep=0.02 cm,parsep=0.05 cm,partopsep=0pt,itemsep=0pt,leftmargin=0.4 cm + 10pt]
}{\end{itemize}}
...
\begin{document}
    ...
    \section{Sobre mí}
        \begin{onecolentry}
Soy actuario de la UNAM con \textbf{SOA Exam Probability aprobado}, becario de ciencia de datos en \textbf{Grupo Gigante} y co-autor de artículo en el IGF-UNAM. Cuantifico \textbf{riesgo financiero} con el rigor que una decisión de portafolio exige: \textbf{VaR/CVaR} con cópulas, \textbf{Monte Carlo} sobre derivados y curvas forward, optimización \textbf{Markowitz}, scoring crediticio topológico en \textbf{Neo4j}. Practico la formación continua y disfruto el trabajo colaborativo con equipos multidisciplinarios. En \href{https://gonorandres.github.io/blog/}{mi página web} comparto lo que aprendo y construyo.
        \end{onecolentry}
...
\begin{onecolentry}
    \begin{highlightsforbulletentries}
        \item \textit{Lenguajes:} Python, R, SQL, Bash, Git, \LaTeX
        \item \textit{Finanzas Cuantitativas:} VaR, CVaR, Black-Scholes, Monte Carlo, Derivados (opciones, forwards), Curvas forward, Markowitz, Cópulas, EVT, Series de Tiempo, Backtesting
        \item \textit{Ciencia Actuarial:} Lee-Carter, BEL, RCS/SCR, LISF/CUSF, Pensiones IMSS, Procesos de renovación
        \item \textit{ML \& Datos:} scikit-learn, XGBoost, LightGBM, GLM, Neo4j, PySpark, Databricks, Pandas, BigQuery
        \item \textit{IA \& DevOps:} LLMs, Claude API, Docker, GitHub Actions, Terraform
...
\begin{twocolentrynarrow}{\href{https://gonorandres.github.io/blog/risk-analyst/}{blog}}
    ...
    \begin{highlights}
        \item El riesgo cuantitativo no se domina con un modelo único. Serie de 13 proyectos desde \hl{VaR/CVaR} hasta contagio sistémico, con acciones, bonos y opciones sobre datos reales de mercado. \textit{Python, Monte Carlo, cópulas, deep learning.}
    \end{highlights}
...
\begin{twocolentrynarrow}{\href{https://simulador-pension-d3qj5vwxtq-uc.a.run.app/}{app live}}
    ...
    \begin{highlights}
        \item Cuantificar la brecha pensional bajo tres regímenes exige modelar trayectorias salariales y rendimientos AFORE. App que estima bajo \hl{Ley 73}, \hl{Ley 97} y \hl{Fondo Bienestar} con análisis de sensibilidad. \textit{R, Shiny, bslib.}
    \end{highlights}
\end{twocolentrynarrow}
