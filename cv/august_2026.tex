...
%
% August 2026 CV — Andrés González Ortega (ES base)
...
\position{Actuario{\enskip\cdotp\enskip}Ciencia de Datos{\enskip\cdotp\enskip}GCP}
...
\begin{cvparagraph}
Soy actuario de la UNAM con \textbf{SOA Exam Probability aprobado}, becario de ciencia de datos en \textbf{Grupo Gigante} y co-autor de artículo científico en el \textbf{IGF-UNAM}. He construido \textbf{25+ proyectos} donde convergen datos, finanzas y riesgo: desde mortalidad y siniestros hasta comportamiento de clientes y redes de crédito, cada uno documentado, probado y desplegado en producción. Practico la formación continua y disfruto el trabajo colaborativo con equipos multidisciplinarios. En mi \hrefIcon{https://gonor.me/}{página web} publico 25+ proyectos en producción, notas técnicas bilingües y aprendizajes abiertos a cualquier disciplina.
\end{cvparagraph}
