...
export const projects: Project[] = [
  ...
  // source: CNSF open data — 5.1M GMM claims, 95.9M insured-years (2020-2024)
  {
    ...
    description: {
      es: 'Pipeline actuarial completo de tarificación para seguros de Gastos Médicos Mayores: 5.1M siniestros y 95.9M asegurados-año (CNSF 2020-2024) clasificados en tres niveles de hospitalización con IA, cálculo de prima por frecuencia-severidad ajustada por inflación médica, y tarificador interactivo desplegado en Vercel.',
      en: 'End-to-end actuarial pricing pipeline for Major Medical Expenses insurance: 5.1M claims and 95.9M insured-years (CNSF 2020-2024) classified into three hospitalization levels with AI, frequency-severity premium calculation adjusted for medical inflation, and interactive tariff calculator deployed on Vercel.',
    },
