...
export const projects: Project[] = [
  ...
  // source: NAIC Schedule P (insurance reserves), Olist e-commerce (Kaggle), Airbnb CDMX (Inside Airbnb)
  {
    ...
    urls: [
      ...
      { label: { es: 'NovaCRM - KPIs Ejecutivos', en: 'NovaCRM - Executive KPIs' }, url: 'https://data-analyst.gonor.me/kpi' },
      { label: { es: 'Portafolio Activos - Finanzas', en: 'Asset Portfolio - Finance' }, url: 'https://data-analyst.gonor.me/portfolio' },
