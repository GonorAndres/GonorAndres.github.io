export default {
  ...
  'notes.subtitle': 'Documentos listos para leer: analisis, reportes y resumenes tecnicos de actuaria, finanzas y estadistica.',
  'notes.searchPlaceholder': 'Buscar notas...',
  'notes.noResults': 'No se encontraron notas para esta busqueda.',
  'notes.noteSingular': 'nota',
  'notes.notePlural': 'notas',
  'notes.allNotes': 'Todas las notas',
  'notes.categories': 'Categorias',
  ...
  'notes.allCategories': 'Todas las categorias',
