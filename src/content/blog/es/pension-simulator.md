...
Un detalle conecta con otros proyectos del portafolio: el retiro programado de Ley 97 divide el saldo entre la esperanza de vida restante. Esas vienen de tablas de CONAPO (17 años para hombres a los 65, 20 para mujeres). Un modelo actuarial más sofisticado proyectaría la mortalidad con mejoras seculares en longevidad, ajustando las pensiones resultantes. Eso está fuera del alcance de este calculador, pero es la siguiente capa de precisión.
