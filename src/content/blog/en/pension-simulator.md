...
One detail links to other projects in the portfolio: the Ley 97 scheduled withdrawal divides the balance by remaining life expectancy. Those come from CONAPO tables (17 years for a 65-year-old man, 20 for a woman). A more sophisticated actuarial model would project mortality with secular improvements in longevity, adjusting the resulting pensions. That's beyond the scope of this calculator, but it's the next layer of precision.
